...
import com.tuespotsolutions.ravinder077.friendsapp.adpter.PagePagerAdapter;
...
import com.tuespotsolutions.ravinder077.friendsapp.service.PhotoService;

public class PageMainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pagemaininformation);
       ...
       //startService(new Intent(this, PhotoService.class));
        ...
        final ViewPager viewPager = (ViewPager) findViewById(R.id.pagepager);
        final PagePagerAdapter adapter = new PagePagerAdapter
